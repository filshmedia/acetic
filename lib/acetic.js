...
function acetic(options) {
  ...
  if(typeof this.options.checkModifiedDate === "undefined") this.options.checkModifiedDate = true;

  // Should we compile the assets?
  if(typeof this.options.compileAssets === "undefined") this.options.compileAssets = true;
