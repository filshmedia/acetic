...
Middleware.prototype.init = function (req, res, next) {
  var assetTypes = Object.keys(this.options.assets);
  var self = this;
  ...
  for (var i = 0; i < assetTypes.length; i++) {
    ...
    var assetConfig = self.options.assets[assetType];
 ...
 * @public
 */
Middleware.prototype.registerCompiler = function(name, compiler) {
